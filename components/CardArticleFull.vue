<template>
  <NuxtLink :to="`/articles/${article.slug}`">
    ...
    >
      <div class="relative m-0 w-full lg:w-[32vw] min-[2536px]:w-[20vw] h-2/5 lg:h-full shrink-0 overflow-hidden rounded-xl rounded-r-none lg:rounded-r-none bg-gray-200 bg-clip-border text-gray-700">
        <NuxtImg
          provider="storyblok"
          :placeholder="[112]"
