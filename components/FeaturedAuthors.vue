<template>
  <section class="bg-white py-12">
    <div class="container mx-auto px-4 xl:px-16 py-12 rounded-xl grid gap-8 grid-cols-12 bg-gray-100">
      <div class="col-span-12">
        <h1
          class="text-4xl font-display font-black capitalize text-gray-800"
        >
          Featured Authors
        </h1>
      ...
      <div class="col-span-3 group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-300 hover:bg-blue-600">
        <img
        ...
        <p
          class="mt-2 capitalize text-gray-500 group-hover:text-gray-300"
        >
          design director
        </p>
