<template>
  <section class="flex items-center justify-center p-10 bg-white">
    <div class="container mx-auto px-4 xl:px-16 grid gap-8 lg:grid-cols-2 lg:grid-rows-2">
      <div class="row-span-2 flex flex-col rounded-lg bg-white border-4 border-black overflow-hidden">
      ...
      <div class="flex rounded-lg border-4 bg-white border-black overflow-hidden">
