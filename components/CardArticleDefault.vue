<template>
  <NuxtLink :to="`/articles/${article.slug}`">
    <div 
      class="card-full relative flex flex-col w-full min-h-[604px] rounded-xl bg-white bg-clip-border border border-gray-200 text-gray-700 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 cursor-pointer"
    >
      ...
      <div class="p-6 h-full flex">
        <div class="article-info">
          ...
          <h3 class="mb-2 block text-2xl font-black leading-snug tracking-normal text-blue-gray-900 antialiased hyphens-auto" lang="en">
            {{ article.content.title || "New Title" }}
          </h3>
          <p class="mb-4 block text-base font-normal leading-relaxed text-gray-700 antialiased hyphens-auto" lang="en">
