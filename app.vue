...
.cookieControl__ModalContent .cookieControl__ModalInputWrapper input:checked + button {
  @apply bg-black
}
.cookieControl__ModalContent .cookieControl__ModalInputWrapper input:disabled + button {
  @apply bg-gray-300
}
</style>